...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ZEROPI
#endif
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define PID_dT ((OVERSAMPLENR * 10.0)/(8000000 / 16.0 / 500))
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {87.489,87.489,(200.0*16/0.7),92.65}  // default steps per unit for Ultimaker
