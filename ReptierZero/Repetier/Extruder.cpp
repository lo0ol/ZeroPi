...
void TemperatureController::updateCurrentTemperature()
{
    ...
    case 12:
    {
        ...
        uint8_t i=2;
        // todo: fixme, pgm_read_word_near only return lower addr
        const short *temptable = (const short *)(temptables[type]); //pgm_read_word_near(&temptables[type]);
        ...
        //OUT_P_I("temptable[0] ", temptable[0]);OUT_P_I_LN(" temptable[1] ", temptable[1]);
        while(i<num)
        {
            ...
            if (newraw > currentTemperature)
            {
                ...
                //OUT_P_I("N:",i);OUT_P_I(" RC N:",newtemp);OUT_P_I_LN(" NR:",newraw);
